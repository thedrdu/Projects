...
LIBSSTATIC_CONFIG          := -lfreetype -lz -lbz2 -L/opt/homebrew/Cellar/libpng/1.6.38/lib -lpng16 -lz -L/opt/homebrew/Cellar/harfbuzz/5.2.0/lib -L/opt/homebrew/opt/freetype/lib -L/opt/homebrew/Cellar/libpng/1.6.37/lib -L/opt/homebrew/Cellar/graphite2/1.3.14/lib -L/opt/homebrew/Cellar/glib/2.74.0/lib -L/opt/homebrew/opt/gettext/lib -L/opt/homebrew/Cellar/pcre2/10.40/lib -lharfbuzz -lm -framework ApplicationServices -lfreetype -lz -lbz2 -lpng16 -lz -lgraphite2 -lglib-2.0 -lintl -liconv -framework Foundation -framework CoreFoundation -framework AppKit -framework Carbon -lm -lpcre2-8 -D_THREAD_SAFE -pthread -L/opt/homebrew/Cellar/brotli/1.0.9/lib -R/opt/homebrew/Cellar/brotli/1.0.9/lib -lbrotlidec -R/opt/homebrew/Cellar/brotli/1.0.9/lib -lbrotlicommon
build_libtool_libs         := 
ft_version                 := 24.3.18
